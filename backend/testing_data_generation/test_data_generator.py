...
num_rows = 15  # Number of rows to generate
...
for _ in range(num_rows):
    ...
    # Insert the generated data into the database
    query = "insert into backend_task (task_title, description, price, booking_price, total_price, location, location_link, lat, longitude, completed_on, status, is_paid, create_date, modify_date, offer, category_id, user_id) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"
    values = (task_title, description, price, booking_price, total_price, location, location_link, latitude, longitude, completed_on_date, status, is_paid, create_date, modify_date, offer, category_id, user_id)
    cursor.execute(query, values)
